...
import pytesseract
import tkinter
from tkinter import Tk, Button, Canvas, Frame, Toplevel
import datetime
import pyautogui
import pyperclip
import os
...
pytesseract.pytesseract.tesseract_cmd = "<PATH TO TESSERACT BINARY>"

def take_bounded_screenshot(x1, y1, x2, y2):
    image = pyautogui.screenshot(region=(x1, y1, x2, y2))
    file_name = datetime.datetime.now().strftime("%f")
    image.save(file_name + ".png")
    print(pytesseract.image_to_string(Image.open(os.getcwd()+'\\' +file_name+".png")).strip())
    pyperclip.copy(pytesseract.image_to_string(Image.open(os.getcwd()+'\\' +file_name+".png")).strip())
...
class Application():
    def __init__(self, master):
        ...
        self.menu_frame.pack(fill=tkinter.BOTH, expand=tkinter.YES, padx=1, pady=1)
        ...
        self.picture_frame.pack(fill=tkinter.BOTH, expand=tkinter.YES)
    ...
    def create_screen_canvas(self):
        ...
        self.snip_surface.pack(fill=tkinter.BOTH, expand=tkinter.YES)
